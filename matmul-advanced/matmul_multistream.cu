...
int main(int argc, char* argv[]) {
    ...
    // 結果出力
    printf("\n実行時間比較:\n");
    printf("1. 複数ストリームでGridを分散 (%d ストリーム): %.3f ms\n", numStreams, time1);
    printf("2. 単一ストリームにGridを載せ: %.3f ms\n", time2);
    printf("3. 一つのGridにまとめて計算 : %.3f ms\n", time3);
