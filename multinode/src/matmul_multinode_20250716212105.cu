...
int main(int argc, char **argv) {
    ...
    if (rank == 0) {
        ...
        // 各ランクからデータを収集
        MPI_Gather(&timings.dataDistribution, 1, MPI_DOUBLE, allDataDistribution, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.hostToDevice, 1, MPI_DOUBLE, allHostToDevice, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.kernelExecution, 1, MPI_DOUBLE, allKernelExecution, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.deviceToHost, 1, MPI_DOUBLE, allDeviceToHost, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.dataCollection, 1, MPI_DOUBLE, allDataCollection, 1, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        ...
        // 他のランクも自分のデータを送信
        MPI_Gather(&timings.dataDistribution, 1, MPI_DOUBLE, nullptr, 0, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.hostToDevice, 1, MPI_DOUBLE, nullptr, 0, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.kernelExecution, 1, MPI_DOUBLE, nullptr, 0, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.deviceToHost, 1, MPI_DOUBLE, nullptr, 0, MPI_DOUBLE, 0, MPI_COMM_WORLD);
        MPI_Gather(&timings.dataCollection, 1, MPI_DOUBLE, nullptr, 0, MPI_DOUBLE, 0, MPI_COMM_WORLD);
