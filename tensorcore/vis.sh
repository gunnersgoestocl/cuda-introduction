#!/bin/bash
# filepath: /work/gc64/c64098/spring-training/cuda-introduction/tensorcore/visualize_tensorcore.sh

# 使用方法チェック
if [ $# -ne 1 ]; then
    echo "使用方法: $0 <timestamp>"
    echo "例: $0 20250708172351"
    echo "これは result_20250708172351.txt を処理します"
    exit 1
fi
